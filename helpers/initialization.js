...
/**
 * This file is used for initializing some
...
// Set up WebSocket provider based on environment (local or mainnet)
if (config.PROJECT_SETTINGS.isLocal) {
  provider = new ethers.providers.WebSocketProvider(`ws://127.0.0.1:8545/`);
} else {
  provider = new ethers.providers.WebSocketProvider(`wss://arb-mainnet.g.alchemy.com/v2/${process.env.ALCHEMY_API_KEY}`);
}
